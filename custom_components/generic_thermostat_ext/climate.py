...
DEFAULT_NAME = "Generic Thermostat Ext"

CONF_HEATER = "heater"
CONF_HEATERS_REL = "heaters_related"
...
async def async_setup_platform(
    ...
    heaters_entity_ids = config.get(CONF_HEATERS_REL)
...
class GenericThermostat(ClimateEntity, RestoreEntity):
    ...
    def __init__(
        ...
        self.heaters_entity_ids = heaters_entity_ids
